...
Para completar la revisión, bajen [este mismo archivo en formato qmd](../files/templates/template-revision-cruzada-trabajo1.qmd){download="template-revision-cruzada.qmd"} y luego enviarlo con el nombre "revisión-cruzada-trabajo1-GrupoX.qmd" (donde "GrupoX" es el número del grupo que revisaron) a través del formulario de entrega de la revisión cruzada, que se habilitará una vez entregados los reportes finales.
