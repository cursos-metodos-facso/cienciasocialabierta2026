...
Para completar la revisión, bajen [este mismo archivo en formato qmd](/files/templates/template-revision-cruzada-trabajo1.qmd) y luego enviarlo con el nombre "revisión-cruzada-trabajo1-GrupoX.qmd" (donde "GrupoX" es el número del grupo que revisaron) a través del formulario de entrega de la revisión cruzada, que se habilitará una vez entregados los reportes finales.

La revisión debe realizarse de forma **anónima**.

Los repositorios para revisar se encuentran disponibles en la sección de [Grupos y repositorios de entrega](/trabajos/trabajos.qmd#grupos-y-repositorios-de-entrega) de la página de trabajos. 
