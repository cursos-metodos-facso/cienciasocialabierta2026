...
El objetivo de esta entrega es evaluar la capacidad de los estudiantes para desarrollar un proyecto de investigación abierto, aplicando los conceptos y herramientas de la ciencia abierta, y para comunicar de manera efectiva el proceso y los resultados de su investigación a través de un reporte dinámico.

Para este proyecto abierto, se les pedirá a los estudiantes que desarrollen un proyecto de investigación basado en sus propios intereses, utilizando un flujo de trabajo reproducible y abierto. El proyecto debe incluir:

- Un repositorio abierto (por ejemplo, en GitHub) que contenga el código y los datos necesarios para reproducir el análisis.
- Un reporte dinámico generado a través de Rmarkdown/Quarto que documente el proceso de investigación, incluyendo la metodología, los resultados y las conclusiones. El reporte debe ser claro y detallado, permitiendo a otros investigadores seguir el mismo proceso y obtener los mismos resultados.
- Una presentación de los resultados del proyecto, utilizando herramientas de visualización de datos y comunicación efectiva.
