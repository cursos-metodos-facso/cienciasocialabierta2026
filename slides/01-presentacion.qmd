...
#
## ¿Cómo se produce el conocimiento científico? {.center .text-center data-background-color="#9B2626"}


# ¿Crisis de reproducibilidad en ciencia? {data-background-color="#9B2626"}

<span style="font-size: 1.5em; font-weight: bold; color: #dfc117;">1. Transparencia</span>

<span style="font-size: 1.5em; color: #5f6469;">2. Reproducibilidad</span>

<span style="font-size: 1.5em; color: #5F6469;">3. Acceso</span>
...
<span style="font-size: 1.5em; color: #5F6469;">1. Transparencia</span>

<span style="font-size: 1.5em; color: #dfc117;">2. Reproducibilidad</span>

<span style="font-size: 1.5em; color: #5F6469;">3. Acceso</span>

## Reproducibilidad

![](img/01/flujo_rep.png)
...
<span style="font-size: 1.5em; color: #dfc117;">3. Acceso</span>

## Acceso

![](img/01/flujo_acceso.png)
...
![](img/01/openbeneficios.png){width="100%"}
