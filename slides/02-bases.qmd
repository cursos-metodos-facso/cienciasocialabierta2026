...
# Sesión 2: Antecedentes {data-background-color="red" style="text-align: right;"}

[1. Resumen sesión anterior]{style="color: white;"}<br>
[2. Principios de la ciencia]{style="color: white;"}<br>
[3. Problemas de apertura]{style="color: white;"}

# Sesión 2: Antecedentes {data-background-color="red" style="text-align: right;"}

[**1. Resumen sesión anterior**]{style="color: yellow;"}<br>
[2. Principios de la ciencia]{style="color: white;"}<br>
[3. Problemas de apertura]{style="color: white;"}
...
[1. Resumen sesión anterior]{style="color: white;"}<br>
[**2. Principios de la ciencia**]{style="color: yellow;"}<br>
[3. Problemas de apertura]{style="color: white;"}
...
[1. Resumen sesión anterior]{style="color: white;"}<br>
[2. Principios de la ciencia]{style="color: white;"}<br>
[**3. Problemas de apertura**]{style="color: yellow;"}
...
# Presión por publicar {data-background-color="#1c1c1c" style="text-align: right; vertical-align: bottom;"}
...
::: {style="text-align: center;"}
![](img/02/publicationbias.png){width="50%"}
:::

# ¿Alternativas? {data-background-color="#1c1c1c"}
...
## [Resumen (I)]{style="color: orange;"} {data-background-color="#1c1c1c"}
...
## [Resumen (II): Enfrentando la crisis]{style="color: orange;"} {data-background-color="#1c1c1c"}
...
## [Próxima clase]{style="color: yellow;"} {data-background-color="red"}
