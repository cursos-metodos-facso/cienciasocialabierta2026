...
Para ello, utilizaremos una [presentación de ejemplo](https://cienciasocialabierta.netlify.app/assignment/pres-ejemplo/pres-ejemplo.html)
...
| Opción             | Acción                                                        |
|--------------------|---------------------------------------------------------------|
| `number-slide`     | Se visualiza el número de las slides de la presentación       |
